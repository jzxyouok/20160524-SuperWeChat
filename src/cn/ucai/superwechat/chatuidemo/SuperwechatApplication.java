...
public class SuperwechatApplication extends Application {
	...
	/**全局的当前登录的账号好友列表集合*/
	private HashMap<String, Contact> mUserList = new HashMap<>();
	/**全局的当前登录的账号的私密群集合*/
	private ArrayList<Group> mGroupList = new ArrayList<>();
	/**全局的登录的账号的公开群的集合*/
	private ArrayList<Group> mPublicGroupList = new ArrayList<>();
	/**全局的登录的账号的群的成员列表集合*/
	private HashMap<String, ArrayList<Member>> mGroupMembers = new HashMap<>();
	...
	public void setUserList(HashMap<String, Contact> mUserList) {
	...
	public void setGroupList(ArrayList<Group> mGroupList) {
	...
	public void setPublicGroupList(ArrayList<Group> mPublicGroupList) {
	...
	public void setGroupMembers(HashMap<String, ArrayList<Member>> mGroupMembers) {
